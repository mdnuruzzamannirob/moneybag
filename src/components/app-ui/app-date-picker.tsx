...
export function AppDatePicker({
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        align="start"
        className="w-auto overflow-visible rounded-lg border border-border p-0 shadow-xl"
      >
        <Calendar
