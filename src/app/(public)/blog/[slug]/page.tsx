  ...
  return (
    <>
      <article>
        ...
        <div
          className={`public-dots mx-auto h-72 max-w-5xl rounded-3xl bg-linear-to-br ${post.color} sm:h-96`}
        />
        <div className="public-legal mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <section className="border-y border-border bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-2">
            {related.map((item) => (
              <Link className="public-card p-6" href={`/blog/${item.slug}`} key={item.slug}>
